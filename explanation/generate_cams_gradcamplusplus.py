...
from pytorch_grad_cam import LayerCAM, GradCAM, EigenCAM, ScoreCAM, GradCAMPlusPlus
...
for i in range(len(imageids_to_run)):
    ...
    # ax[0].imshow(datapt_resized)
    # ax[1].imshow(datagt_resized)
    # ax[2].imshow(datagt_resized)
    # ax[2].scatter(center[1], center[0], color='red')
    # ax[3].imshow(grayscale_cam_1c)
